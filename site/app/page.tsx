...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* KONFORTECH PREVIEW */}
      <section className="mx-auto max-w-content px-6 py-24">
        <div className="border border-line p-10 sm:p-14 relative overflow-hidden">
          <span className="signal-label text-ember">KONFORTECH BÉNIN</span>
          <h2 className="mt-4 font-display text-3xl sm:text-4xl text-ink max-w-lg">{h.konfortechText}</h2>
          <div className="mt-8">
