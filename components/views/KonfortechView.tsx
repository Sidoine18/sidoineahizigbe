...
export default function KonfortechView() {
  const { t } = useLanguage();
  ...
  return (
    <section className="mx-auto max-w-content px-6 py-20 sm:py-28">
      ...
      <div className="mt-16 bg-navy p-10 text-center">
        <h2 className="font-display text-2xl text-navy-ink">{k.ctaTitle}</h2>
        <p className="mt-3 text-navy-mute max-w-md mx-auto">{k.ctaText}</p>
